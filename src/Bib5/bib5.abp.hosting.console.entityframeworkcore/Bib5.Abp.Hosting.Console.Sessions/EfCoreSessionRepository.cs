...
public class EfCoreSessionRepository : EfCoreRepository<IBib5AbpHostingConsoleDbContext, Session, string>, ISessionRepository, IBasicRepository<Session, string>, IBasicRepository<Session>, IReadOnlyBasicRepository<Session>, IRepository, IReadOnlyBasicRepository<Session, string>
{
	public EfCoreSessionRepository(IDbContextProvider<IBib5AbpHostingConsoleDbContext> dbContextProvider)
