...
public static class SerilogConfigurationHelper
{
	public static void Configure(string? appName = null)
	{
		...
		{
			FileLoggerConfigurationExtensions.File(c, logFile, (LogEventLevel)0, "{Timestamp:yyyy-MM-dd HH:mm:ss.fff zzz} [{Level:u3}] {Message:lj}{NewLine}{Exception}", (IFormatProvider)null, (long?)1073741824L, (LoggingLevelSwitch)null, false, false, (TimeSpan?)null, (RollingInterval)0, false, (int?)31, (Encoding)null, (FileLifecycleHooks)null, (TimeSpan?)null);
		}, 10000, false);
